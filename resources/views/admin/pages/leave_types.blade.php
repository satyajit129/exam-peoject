...
@section('backend_content')
    <div class="card card-default mb-4">
        <div class="card-header">
            ...
            <a href="{{ route('leaveTypeCreateOrEdit') }}" class="btn btn-outline-primary btn-sm">Add New Leave Type</a>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-outline-warning ml-2 " title="Edit"
                                    href="{{ route('leaveTypeCreateOrEdit', $leave_type->id) }}">
                                    <i class="mdi mdi-pencil"></i>
                                </a>
                                <a href="javascript:void(0);"
                                    data-url="{{ route('leaveTypeDelete', ['id' => $leave_type->id]) }}"
                    ...
                    @empty
                        <tr>
                            <td class="text-center" colspan="3">No data Found! PLease add data from <a
                                    href="{{ route('leaveTypeCreateOrEdit') }}">here</a> </td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
